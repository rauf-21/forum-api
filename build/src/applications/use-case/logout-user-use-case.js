...
var _LogoutUserUseCase_authenticationRepository;
...
const LogoutUserUseCasePayloadSchema = zod_1.z.object({
...
class LogoutUserUseCase {
    constructor(dependencies) {
        _LogoutUserUseCase_authenticationRepository.set(this, void 0);
        const { authenticationRepository } = dependencies;
        __classPrivateFieldSet(this, _LogoutUserUseCase_authenticationRepository, authenticationRepository, "f");
    }
    async execute(payload) {
        ...
        await __classPrivateFieldGet(this, _LogoutUserUseCase_authenticationRepository, "f").verifyTokenIsExists(refreshToken);
        await __classPrivateFieldGet(this, _LogoutUserUseCase_authenticationRepository, "f").deleteToken(refreshToken);
    }
}
exports.LogoutUserUseCase = LogoutUserUseCase;
_LogoutUserUseCase_authenticationRepository = new WeakMap();
